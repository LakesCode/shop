...
$html_title = '电商光魔提供最新版SHOPNC官方安装程序';

$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>电商光魔提供最新版SHOPNC官方安装程序</h5>
      <h2>系统安装向导</h2>
    </div>
    <div class="version">版本: 2014.12.22.8256</div>
  </div>
</div>
...
$html_footer = <<<EOF
<div class="footer">
  <h5>Powered by <font class="blue">E</font><font class="orange">Mall</font></h5>
  <h6>版权所有 2007-2014 &copy; <a href="http://www.shopnc.cn" target="_blank">天津市网城天创科技有限责任公司</a>/<a href="http://www.shopnc.cn" target="_blank">网店技术中心提供</a></h6>
  <h6>软件注册登记编号：软著登字第1450314号</h6>
</div>
EOF;
